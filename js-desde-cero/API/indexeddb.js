...
// Almacena llaves de llave-valor. Los valores pueden ser objetos con estructuras completas, y las llaves pueden ser propiedades de esos objetos.
...
if(indexedDB && form){
    ...
    const updateData = (data) =>{
        ...
        request.onsuccess = () =>{
            ...
            form.button.textContent = "Add Taks"
            readData()
        }
    }
